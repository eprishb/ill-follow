                    ...
                    <Card className="iq-border-radius-20">
                        <Card.Body>
                            ...
                            <Row className="form-group">
                                <Form.Label htmlFor="inputEmail3" column sm="2" className="col-form-label">To:</Form.Label>
                                <Col sm="10" >
                                     <Select
                                        className="dropdown"
                                        placeholder=""
                            ...
                            <Row className="form-group">
                                ...
                                <Col sm="10">
                                     <Select type="text"
                                        className="dropdown"
                                        placeholder=""
                                        value={data2.filter(obj => selectedValue1.includes(obj.value))} // set selected values
