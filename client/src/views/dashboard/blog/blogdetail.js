                        ...
                        <div className="blog-description mt-3">
                           ...
                           <div className="blog-meta d-flex align-items-center mb-3 position-right-side flex-wrap">
                              <div className="date me-4">
                                 <i className="ri-calendar-2-fill text-primary pe-2"></i>2 Weeks ago
                              </div>
                              <div className="like me-4">
                                 <i className="ri-thumb-up-line text-primary pe-2"></i>20 like
                              </div>
                              <div className="comments me-4">
                                 <i className="ri-chat-3-line text-primary pe-2"></i>82 comments
                              </div>
                              <div className="share">
                                 <i className="ri-share-forward-line text-primary pe-2"></i>share
                              </div>
                           </div>
                           ...
                           <Link to="#" tabIndex="-1">Read More <i className="ri-arrow-right-s-line"></i></Link>
                        </div>
                     </Card.Body>
                  </Card>
               </Col>
                        ...
                        <ul className="list-inline p-0 mb-0 mt-2">
                              ...
                              <Row className="align-items-top pb-3 border-bottom">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">4 Weeks ago</Link></div>
                           ...
                           <li className="mb-3">
                              <Row className="align-items-top pb-3 border-bottom">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">3 Weeks ago</Link></div>
                                       <h6>All the Lorem Ipsum generators</h6>
                                    </div>
                                 </Col>
                              </Row>
                           ...
                           <li className="mb-3">
                              <Row className="align-items-top pb-3 border-bottom">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">2 Weeks ago</Link></div>
                                       <h6>All the Lorem Ipsum generators</h6>
                                    </div>
                                 </Col>
                              </Row>
                           ...
                           <li className="mb-3">
                              <Row className="align-items-top pb-3 border-bottom">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">1 Week ago</Link></div>
                                       <h6>All the Lorem Ipsum generators</h6>
                                    </div>
                                 </Col>
                              </Row>
                           ...
                           <li className="mb-3">
                              <Row className="align-items-top pb-3 border-bottom">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">3 days ago</Link></div>
                                       <h6>All the Lorem Ipsum generators</h6>
                                    </div>
                                 </Col>
                              </Row>
                           ...
                           <li>
                              <Row className="align-items-top">
                                 ...
                                 <Col md="7">
                                    <div className="blog-description mt-1 mt-md-0">
                                       <div className="date mb-1"><Link to="#" tabIndex="-1">2 Days ago</Link></div>
                                       <h6>All the Lorem Ipsum generators</h6>
                                    </div>
                                 </Col>
                              </Row>
                                 ...
                                 <Card.Body>
                                    ...
                                    <div className="blog-description">
                                       ...
                                       <div className="d-flex align-items-center justify-content-between mb-2 position-right-side"> 
                                          <Link to="#" className="comments"><i className="ri-chat-3-fill pe-2"></i>82 comments</Link>
                              ...
                              <Card className="card-block card-stretch card-height blog">
                                 <Card.Body>
                                    ...
                                    <div className="blog-description">
                                       ...
                                       <div className="d-flex align-items-center justify-content-between mb-2 position-right-side"> 
                                          <Link to="#" className="comments"><i className="ri-chat-3-fill pe-2"></i>98 comments</Link>
                                          <span className="font-size-12 text-warning">
                                             <i className="fa fa-star"></i>
                                             <i className="fa fa-star"></i>
                                             <i className="fa fa-star"></i>
                              ...
                              <Card className="card-block card-stretch card-height blog">
                                 <Card.Body>
                                    ...
                                    <div className="blog-description">
                                       ...
                                       <div className="d-flex align-items-center justify-content-between mb-2 position-right-side"> 
                                          <Link to="#" className="comments"><i className="ri-chat-3-fill pe-2"></i>28 comments</Link>
                                          <span className="font-size-12 text-warning">
                                             <i className="fa fa-star"></i>
                                             <i className="fa fa-star"></i>
                                             <i className="fa fa-star"></i>
                              ...
                              <Card className="card-block card-stretch card-height blog mb-0">
                                 ...
                                 <Card.Body>
                                    <Form>
                                       ...
                                       <Button type="button" variant="btn btn-primary me-2">button</Button>
                                       <Button type="button" variant="btn bg-soft-danger">Cancel</Button>
                                    </Form>
                                 </Card.Body>
                              </Card>
                           </Col>
