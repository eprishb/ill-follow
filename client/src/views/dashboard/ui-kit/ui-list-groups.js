                ...
                <Row>
                    ...
                    <Col sm="6" lg="6">
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <p>Add the <code>flush</code> variant to remove outer borders and rounded corners to render list group items edge-to-edge in a parent container <code>such as a Card</code>.</p>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <p>Add badges to any list group item to show unread counts, activity, and more with the help of some <a href="/docs/5.0/utilities/flex/">utilities</a>.</p>
                                <ListGroup>
                    ...
                    <Col sm="12" lg="6">
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <p>Toggle the <code>action</code> prop to create actionable list group items, with disabled, hover and active styles. List item actions will render a <code> &lt;button&gt;  </code> or <code> &lt;a&gt; </code> (depending on the presence of an <code> href </code>) by default but can be overridden by setting the as prop <code>as</code> usual.</p>
