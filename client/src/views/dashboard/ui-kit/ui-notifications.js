                    ...
                    <Col sm="12">
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <ToastContainer>
                                    <Toast className="fade show bg-primary text-white" role="alert" aria-live="assertive" aria-atomic="true">
                                    ...
                                    <Toast className="fade show bg-success text-white" role="alert" aria-live="assertive" aria-atomic="true">
