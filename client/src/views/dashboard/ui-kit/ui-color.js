               ...
               <Col lg={6}>
                  <Card>
                     ...
                     <Card.Body>
                        ...
                        <p className="bg-soft-info ps-3 pe-3 pt-2 pb-2 rounded">Info link</p>
               ...
               <Col lg={6}>
                  <Card>
                     ...
                     <Card.Body>
                        ...
                        <p><Link to="#" className="bg-soft-info ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Info link</Link></p>
                        <p className="mb-0"><Link to="#" className="bg-dark ps-3 pe-3 pt-2 pb-2 rounded d-inline-block">Dark link</Link></p>
                     </Card.Body>
                  </Card>
               </Col>
            </Row>
