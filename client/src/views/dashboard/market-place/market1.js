    ...
    return(
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img src={imgm1} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "  loading="lazy"/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Bring HubSpot to your inbox with the HubSpot integration for Gmail.</p>
                        </div>
                        ...
                        <small className="mt-2">
                            <span><span>10,000</span>+ installs</span>
                        </small>
                   </Card.Body>
               </Card>
           </Col>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm3} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0">Integrate HubSpot's lead capture and contact management with WordPress</p>
                        </div>
                        <span className="text-warning d-block line-height mt-0">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Manage channel sales and partner renewals through HubSpot.</p>
                        </div>
                        <div className="mt-4">
                            <small>New</small>
                        </div>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Content experiences your audience will love</p>
                        </div>
                         <div className="mt-4">
                            <small>New</small>
                        </div>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-1">
                            <p className="mb-0">Access your HubSpot data in real time through Amazon's Alexa</p>
                        </div>
                        <div className="mt-4">
                            <small><span><span>50</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-1">
                            <p className="mb-0">Take Data Driven Actions With Enriched Ecommerce Data</p>
                        </div>
                        <div className="mt-1">
                            <small><span><span>40</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm5} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0">Manage all Messenger conversations and bots in HubSpot</p>
                        </div>
                        ...
                        <div className="mt-2">
                        <small><span><span>10,000</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
               ...
               <Card.Body>
                   <div>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0">Data Sync - Sync Airtable rows (with emails) with HubSpot</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>500</span>+ installs</span></small>
                        </div>
                   </div>
                   </Card.Body>
               </Card>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm6} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0">Data Sync - Sync contacts two-way with a Mailchimp Audience</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>3,500</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Send individual SMS to your contacts or use workflows to send bulk SMS</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Dialer, calling & texting automations with real-time logging & syncing</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>100</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
                   ...
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Send and receive SMS without leaving HubSpot. Get started in minutes.</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>300</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
        ...
        <Row>
            <div>
                ...
                <p>Explore powerful and easy-to-use two-way data sync for 25+ apps, built by HubSpot</p>
            </div>
            <Col sm="4" md="4">
               <Card className="cardhover">
                   <Card.Body>
                      {/* <div className="job-icon bg-primary px-3 py-2 mb-2 d-inline-block rounded-circle">
                       ...
                       <img  loading="lazy"  src={imgm7} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0"></p>Sync Google Contacts with HubSpot contacts
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>9000</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <small>Built by HubSpot</small>
                        <div className="mt-2">
                            <p className="mb-0">Data Sync - Sync Stripe and HubSpot customers</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
                        ...
                        <div className="mt-2">
                        <small><span><span>1,000</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
        ...
        <Row>
            <div>
                ...
                <p>Explore apps that can help optimize your marketing campaign efforts in HubSpot.</p>
            </div>
            <Col sm="4" md="4">
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Popular KPI/Analytics Dashboards Amongst HubSpot Customers</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                            <p className="mb-0">Easy-to-create forms, polls, and quizzes for WordPress.</p>
                        </div>
                        <span className="text-warning d-block line-height mt-2">
                            <i className="fa fa-star"></i>
                            <i className="fa fa-star"></i>
               ...
               <Card className="cardhover">
                   <Card.Body>
                      ...
                      <img  loading="lazy"  src={imgm4} alt="mimg" className="avatar avatar-25 job-icon mb-2 d-inline-block "/>
                        ...
                        <div className="mt-2">
                        <small><span><span>1,500</span>+ installs</span></small>
                        </div>
                   </Card.Body>
               </Card>
           </Col>
           ...
           <Row>
            <div>
                ...
                <p>Combine the power of HubSpot’s CRM platform with your favorite media apps</p>
            </div>
            <Col sm="4" md="4">
               <Card className="cardhover">
                   <Card.Body>
