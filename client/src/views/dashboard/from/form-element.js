                            ...
                            <Card.Body>
                                ...
                                <Form>
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Control type="text" defaultValue="Mark Jhon" placeholder="Enter Name"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                                        <Form.Label>Email Input</Form.Label>
                                        <Form.Control type="email" defaultValue="markjhon@gmail.com" placeholder="Enter Email"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Control type="password" defaultValue="markjhon123" placeholder="Enter Password"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                            ...
                            <Card.Body>
                                ...
                                <Form>
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Control type="email" className="form-control-sm" placeholder="form-control-sm"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                                    ...
                                    <Form.Group className="mb-0 form-group">
                                        ...
                                        <Form.Control type="email" className="form-control-lg" placeholder="form-control-lg"/>
                                    </Form.Group>
                                </Form>
                            </Card.Body>
                        </Card>
                                ...
                                <Form className="form-horizontal" action="#">
                                    ...
                                    <Form.Group className="form-group">
                                        <Form.Check className="mb-3">
                                            <Form.Check.Input type="checkbox"  className="me-2" id="flexCheckDefault"/>{' '}
                            ...
                            <Card.Body>
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Control type="text" id="exampleInputPlaceholder" placeholder="This is Placeholder"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                                        <Form.Label>Readonly</Form.Label>
                                        <Form.Control type="text" id="exampleInputReadonly" disaed defaultValue="Mark Jhon"/>
                                    </Form.Group>
                                    <Form.Group className="form-group">
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Check className="d-block">
                                            <Form.Check.Input type="checkbox" id="flexCheckChecked" defaultChecked/>{' '}
                                            <Form.Check.Label >
                                                Checked checkbox
                                            </Form.Check.Label>
                                        </Form.Check>
                                        ...
                                        <Form.Check className="d-block">
                                            <Form.Check.Input type="checkbox" id="flexCheckCheckedDisabled" defaultChecked disabled/>{' '}
                                            <Form.Check.Label>
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Check className="form-radio">
                                            <Form.Check.Input type="radio" id="customRadio5" name="customRadio5"  disabled="" defaultChecked/>{' '}
                                    ...
                                    <Form.Group className="form-group">
                                        ...
                                        <Form.Check className="form-switch">
                                            ...
                                            <Form.Check.Label>Checked switch checkbox input</Form.Check.Label>
                                        </Form.Check>
                                        <Form.Check className="form-switch">
                                            <Form.Check.Input type="checkbox" id="flexSwitchCheckDisabled" disabled/>{' '}
                                            <Form.Check.Label>Disabled switch checkbox input</Form.Check.Label>
                                        </Form.Check>
                                        <Form.Check className="form-switch">
                                            <Form.Check.Input type="checkbox" id="flexSwitchCheckCheckedDisabled" defaultChecked disabled/>{' '}
                                            <Form.Check.Label>Disabled checked switch checkbox input</Form.Check.Label>
                                        </Form.Check>
                                    </Form.Group>
                                    <Form.Group className="form-group">
