                                    ...
                                    <Col md="3">
                                        <ul id="top-tabbar-vertical" className="p-0">
                                            <li className={` ${show === 'A' ? 'active done' : ''} ${show === 'Account' ? 'active done' : ''} ${show === 'Personal' ? 'active done' : ''}  active step1`} id="personal">
                                                <Link to="#">
                                                    <i className="material-symbols-outlined bg-soft-primary text-primary">open_lock</i><span>Personal</span>
                                                </Link>
                                            </li>
                                            ...
                                            <li id="payment" className={` ${show === 'Image' ? 'active done' : ''} step4`}>
                                                <Link to="#">
                                                    <i className="material-symbols-outlined bg-soft-warning text-warning">done</i><span>Payment</span>
                                                </Link>
                                            </li>
                                        </ul>
                                    </Col>
