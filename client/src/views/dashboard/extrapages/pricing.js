                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td className="text-center"></td>
                                                <td className="text-center">
                                                    <h2 className="text-center">$19<small> / Per month</small></h2>
                                                    <Button variant="primary" className="mt-3">Purchase</Button>
                                                </td>
                                                <td className="text-center">
                                                    <h2 className="text-center">$39<small> / Per month</small></h2>
                                                    <Button variant="primary" className="mt-3">Purchase</Button>
                                                </td>
                                                <td className="text-center">
                                                    <h2 className="text-center">$119<small> / Per month</small></h2>
                                                    <Button variant="primary" className="mt-3">Purchase</Button>
                                                </td>
                                                <td className="text-center">
                                                    <h2 className="text-center">$219<small> / Per month</small></h2>
                                                    <Button variant="primary" className="mt-3">Purchase</Button>
                                                </td>
                                            </tr>
                                        </tbody>
