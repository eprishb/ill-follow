			...
			<div className="top-section">
				...
				<div className="field is-grouped">
					<div className="control">
						<input id="tipue_drop_input" className="input" placeholder="Search..." />
				...
				<div className="user-block">
					<img className="avatar" src="https://via.placeholder.com/150x150" data-demo-src="assets/img/avatars/jenna.png" alt="" />
					<div className="meta">
