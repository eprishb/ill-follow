    ...
    return (
        <React.Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <Nav.Item as="li">
                    <Link className={`${location.pathname === '/dashboard/app/chat' ? 'active' : ''} nav-link `} aria-current="page" to="/dashboard/app/chat">
                ...
                <Accordion.Item as="li" eventKey="utilities-error" bsPrefix="nav-item">
                    ...
                    <Accordion.Collapse eventKey="utilities-error">
                        <ul className="sub-nav">
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/extra-pages/pages-maintenance' ? 'active' : ''} nav-link`} to="/errors/maintenance">
                                    <i className="icon">
                                        <svg className="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
