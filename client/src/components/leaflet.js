...
// img
import Leaflet1 from "../assets/images/weather/cloudy.png";
import Leaflet2 from "../assets/images/weather/day.png";
import Leaflet3 from "../assets/images/weather/rainy-1.png";
import Leaflet4 from "../assets/images/weather/snowy-6.png";
import Leaflet5 from "../assets/images/weather/cloudy-day-1.png";
import Leaflet6 from "../assets/images/weather/thunder.png";
...
const Leaflet = (props) => {
  ...
  useEffect(() => {
    ...
    L.marker([32.5, -99.1], { icon: cloudy22 })
      .addTo(map)
      .bindPopup("Cloudy Sunny Day");
    L.marker([43.9, -111.8], { icon: thunder })
      .addTo(map)
      .bindPopup("Thunder Strom");
  }, []);

  return <div id="chart-map-column-04" className={props.className}></div>;
};
