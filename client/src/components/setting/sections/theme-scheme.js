    ...
    return (
        <Fragment>
            ...
            <div className="d-grid gap-3 grid-cols-3 mb-3">
                ...
                <RadioBtn btnName="theme_scheme_direction" imgComponent={true} label="LTR" className="text-center" id="theme-scheme-direction-ltr" defaultChecked={props.themeSchemeDirection} value="ltr" >
                    LTR
                </RadioBtn>
                <RadioBtn btnName="theme_scheme_direction" imgComponent={true} label="RTL" className="text-center" id="theme-scheme-direction-rtl" defaultChecked={props.themeSchemeDirection} value="rtl" >
                    RTL
                </RadioBtn>
            </div>
        </Fragment>
